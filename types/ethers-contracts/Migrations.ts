...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface MigrationsInterface extends Interface {
    getFunction(nameOrSignature: "last_completed_migration" | "owner" | "setCompleted"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'setCompleted', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    last_completed_migration: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    getFunction(nameOrSignature: 'last_completed_migration'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'owner'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'setCompleted'): TypedContractMethod<
      [completed: BigNumberish, ],
      [void],
      'nonpayable'
    >;
